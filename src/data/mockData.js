...
export const mockFeaturedArticles = [
  {
    id: 7,
    title: "Unhealthy Lifestyles Linked to Faster Heart Aging. Here's What Can Help.",
    author: "Daniel",
    audioDuration: "4:01",
    content: "The concept of trying to understand heart health by determining its biological 'age' relative to chronological age has become a topic of interest among cardiologists, researchers, and physicians. Assessing the heart's age could offer a simple, clear way to understand its overall health. It might also predict cardiovascular risks that could be minimized by making heart-healthy lifestyle changes. Now, researchers have developed a new tool to calculate 'heart age.' Using heart health measures like blood pressure and cholesterol levels, cardiologists say the heart age of most Americans is 'older' than their chronological age.",
    image: "Image/Video"
  }
];
